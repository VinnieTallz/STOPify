  ...
  const Contact = () => {
    return (
        ...
        <div className="sm:w-1/2 p-5">
            <div className="text">
                <span className="text-gray-500 border-b-2 border-red-600 uppercase">Contactt us</span>
               ...
               <div>
                 ...
                 <button type="submit" className="w-40 bg-red-500 text-white px-6 py-3 font-xl rounded-md sm:mb-0">Send Message</button>
